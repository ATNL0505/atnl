...
function initializeContactForm() {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        if (isValid) {
            ...
            // The form will be submitted via the action attribute
            showLoadingState();
        } else {
...
// Check for form submission success on page load
...
function initializePageLoadAnimations() {
    // Add slide-in-left class to text elements
    const textElements = document.querySelectorAll('h1, h2, h3, p, .hero-subtitle, .section-header h2, .section-header p');
